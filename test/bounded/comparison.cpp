...
export module bounded.comparison_test;
...
constexpr std::intmax_t int_min = numeric_traits::min_value<int>;
constexpr std::intmax_t int_max = numeric_traits::max_value<int>;
static_assert(
