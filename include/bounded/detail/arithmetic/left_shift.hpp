...
constexpr auto operator<<(
	...
	constexpr auto left_shift = [](auto const lhs, auto const rhs) noexcept {
		return lhs << rhs;
	};
	return detail::operator_overload(lhs_, rhs_, left_shift, [](auto const lhs, auto const rhs) noexcept {
		// TODO: Broaden range
