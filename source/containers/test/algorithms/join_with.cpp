...
constexpr auto compare(
	containers::c_array<containers::string_view, size> const & input,
	containers::string_view const joiner,
	containers::string_view const expected
) -> bool {
	auto rjoined = [&] {
...
static_assert(containers::equal(
	containers::join_with(containers::array<containers::string_view, 0_bi>(), ""_s),
	""_s
));
...
static_assert(containers::linear_size(containers::join_with(containers::array{"a"_s, "ab"_s}, "abc"_s)) == 6_bi);
