...
constexpr ranged_integer<1, 10, throw_policy> const x(9);
static_assert(sizeof(x) == 1, "ranged_integer too big!");
constexpr ranged_integer<-3, 11, throw_policy> const y(x);
constexpr ranged_integer<-3, 11, throw_policy> const z(4);
...
constexpr ranged_integer<0, 2, throw_policy> left_shift_lhs(1);
constexpr ranged_integer<0, 61, throw_policy> left_shift_rhs(3);
...
constexpr ranged_integer<17, 23, throw_policy> positive_range(20);
constexpr ranged_integer<-54, -6, throw_policy> negative_range(-33);
constexpr auto positive_negative_result = positive_range % negative_range;
constexpr ranged_integer<0, 23, throw_policy> positive_negative(20 % -33);
...
constexpr ranged_integer<-22, 0, throw_policy> negative_positive(-33 % 20);
...
constexpr auto result = ranged_integer<0, 10, null_policy>(10) % make_ranged<6>();
