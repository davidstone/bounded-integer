...
constexpr auto operator symbol( \
	ranged_integer<lhs_min, lhs_max, lhs_policy> const lhs, \
	ranged_integer<rhs_min, rhs_max, rhs_policy> const rhs \
) noexcept { \
...
> \
constexpr auto operator symbol(ranged_integer<lhs_min, lhs_max, overflow> const lhs, integer const rhs) noexcept { \
...
template< \
	...
	enable_if_t<std::is_integral<integer>::value> = clang_dummy \
> \
constexpr auto operator symbol(integer const lhs, ranged_integer<rhs_min, rhs_max, overflow> const rhs) noexcept { \
...
constexpr auto operator-(ranged_integer<minimum, maximum, overflow_policy> const value) noexcept {
